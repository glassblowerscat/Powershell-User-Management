    ...
    Else{
                ...
                try {
                    ...
                    switch($pathArray.length){
                       5{$path = "ou=$($pathArray[4]),ou=$($pathArray[3]),ou=$($pathArray[2]),ou=$($pathArray[1]),dc=lifelineyouth,dc=local"
                            }
                       4{$path = "ou=$($pathArray[3]),ou=$($pathArray[2]),ou=$($pathArray[1]),dc=lifelineyouth,dc=local"
                            }
                       3{$path = "ou=$($pathArray[2]),ou=$($pathArray[1]),dc=lifelineyouth,dc=local"
                            }
                       2{$path = "ou=$($pathArray[1]),dc=lifelineyouth,dc=local"
                            }
                        }
					...
					<# ***THIS IS THE OLD WAY***
					#Add the user with above variables
                    New-ADUser `
					-SamAccountName $username `
